...
function CODOrderSummary() {
  ...
  const displayItems = order.orderItems && order.orderItems.length > 0
    ...
    : [{
        ...
        productPrice: order.orderAmount
      }];
      ...
      <div className="card mb-3">
        <div className="card-body">
          ...
          <ul className="list-group list-group-flush">
            ...
            <li className="list-group-item"><strong>Order Status:</strong> {order.orderStatus || 'N/A'}</li>
    ...
    Download Invoice (PDF)
      ...
      >
        ...
        <div style={{ textAlign: 'right', marginTop: 20 }}>
          ...
          <div><strong>Order Status:</strong> {order.orderStatus || 'N/A'}</div>
        </div>
      </div>
    </div>
  );
